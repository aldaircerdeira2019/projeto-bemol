              ...
              >
                <div class="card py-4">
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      <label for="birth" class="col-md-4 col-form-label text-md-right">
                        Data Nasc.</label
                      >
                      <div class="col-md-6">
                        <the-mask
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <input
                          ...
                          autofocus
                        />
                        <div class="invalid-feedback" v-if="errors.logradouro">
                          {{ errors.logradouro[0] }}
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <input
                          ...
                          autofocus
                        />
                        <div class="invalid-feedback" v-if="errors.localidade">
                          {{ errors.localidade[0] }}
                        </div>
                      </div>
                    </div>
...
export default {
  ...
  data() {
   ...
   methods: {
    ...
    getClient() {
      api
        .editCliente(this.$route.params.id)
        .then((response) => {
